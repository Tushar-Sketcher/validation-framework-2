...
def generate_table_comparison_details(table1, table2, filter_condition='', metric_validation_active=False, dimenssion_columns='', dim_metrics_columns='', ignored_columns='', metric_result_table='', materialization=None):
    """
    ...
    """
    data = compare_two_tables(spark, table1, table2, filter_condition, metric_validation_active, dimenssion_columns, dim_metrics_columns, ignored_columns, metric_result_table, materialization)
...
def generate_multiple_table_comparison_details(path):
    ...
    for row in input_rows:
        ...
        if is_validation_active:
            result_rows = compare_two_tables(spark, table1, table2, filter, metric_validation_active, dimenssion_columns, dim_metrics_columns, ignored_columns, metric_result_table, materialization, result_rows)
        else:
